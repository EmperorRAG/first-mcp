/**
 * Implementation of {@link HttpService.address}. Returns the bound
 * address string after {@link HttpService.start} has resolved.
 *
 * @module
 */
...
/**
 * Returns the bound address string; dies if the server is not started
 * or if the underlying address is a Unix socket path.
 */
